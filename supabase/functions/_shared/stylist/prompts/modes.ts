...
Если в availableItems есть совместимое платье и верх или низ не зафиксированы якорем, обязательно сделай хотя бы один вариант по формуле «платье + обувь». Не отказывайся от платья только потому, что в гардеробе есть привычная пара «верх + низ».
...
Сначала выбери самые универсальные и уместные вещи из availableItems, затем проверь, что каждый образ покрывает реальный сценарий поездки. Не добавляй вещь в capsuleItemIds, если она не нужна ни одному образу, и не подменяй отсутствующую вещь похожей.
Если в гардеробе есть подходящее платье и поездка включает ужин, вечер или нарядный сценарий, рассмотри его как отдельную формулу «платье + обувь», а не только обычный верх + низ.
...
Если в availableItems есть совместимое платье, а верх и низ не зафиксированы, один из вариантов обязательно должен использовать платье как самостоятельную основу; остальные варианты могут быть собраны по формуле «верх + низ».
