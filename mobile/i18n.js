(() => {
  ...
  const russianToEnglish = Object.freeze({
    ...
    'Собрать вещи в отпуск': 'Pack for a vacation',
    'Собрать капсулу': 'Build capsule',
    'Капсула для отпуска': 'Vacation capsule',
    'ЧЕМОДАН': 'SUITCASE',
    'На сколько дней': 'How many days',
    'Погода': 'Weather',
    'Как сейчас': 'Current conditions',
    'Тепло · около 25°': 'Warm · around 25°',
    'Мягко · около 18°': 'Mild · around 18°',
    'Прохладно · около 10°': 'Cool · around 10°',
    'Холодно · около 3°': 'Cold · around 3°',
    'Что планируется': 'What are you planning',
    'Можно стирать в поездке?': 'Can you do laundry on the trip?',
    'Нет, беру с запасом': 'No, I will pack extra',
    'Да, можно стирать': 'Yes, laundry is available',
    'Стилист соберёт компактную капсулу из ваших настоящих вещей и покажет несколько образов из неё.': 'Your stylist will build a compact capsule from your real items and show several looks from it.',
    'Город, пляж, прогулки, ужины…': 'City, beach, walks, dinners…',
    'Например, Рим': 'For example, Rome',
    ...
    'УТОЧНИТЬ ОБРАЗ': 'REFINE THE LOOK',
    'Напишите стилисту, что изменить': 'Tell your stylist what to change',
    'Например: замени обувь на более спокойную': 'For example: swap in calmer shoes',
    'Отправить сообщение стилисту': 'Send message to stylist',
    'Сохранить': 'Save',
    'Другой': 'Another',
    'Изменить': 'Edit',
    ...
    'Убрать из образа': 'Remove from look',
    ...
    'Сохранённые': 'Saved',
    'Надетые': 'Worn',
    'СТИЛИСТ · ГАРДЕРОБ': 'STYLIST · WARDROBE',
    'Что докупить,': 'What to buy,',
    'чтобы образы стали полнее?': 'to complete your looks?',
    'Найду 1–3 вещи, которые закроют пробелы и добавят новые сочетания с тем, что уже есть.': 'I’ll find 1–3 pieces that close the gaps and create new combinations with what you already own.',
    'Подобрать покупки': 'Find my next purchases',
    'Обновить рекомендации': 'Refresh recommendations',
    'Изучаю ваш гардероб…': 'Reading your wardrobe…',
    'Палитра': 'Palette',
    'закрывает пробел гардероба': 'fills a wardrobe gap',
    'Спросить стилиста →': 'Ask your stylist →',
    'Работа': 'Work',
    ...
    'Фото спинки (необязательно)': 'Back photo (optional)',
    'Добавьте второе фото, если важна спинка · до 5 МБ': 'Add a second photo when the back matters · up to 5 MB',
    'Фото спереди': 'Front photo',
    'Фото спинки': 'Back photo',
    ...
    'Коллаж образа из вашего гардероба': 'Outfit collage from your wardrobe',
    'Полный образ': 'Complete look',
    'Здесь будет ваш образ': 'Your look will appear here',
    ...
    'Вещь убрана из образа': 'Item removed from the look',
    'Вещь уже не входит в этот образ': 'The item is no longer part of this look',
    'Не удалось убрать вещь из образа': 'Could not remove the item from the look',
    'Образ не вернулся из Supabase.': 'The look was not returned by Supabase.',
